...
namespace math_expr::core::numeric
{
         ...
         template <typename T>
         inline ::math_expr::core::_int64_t to_int64(const T v)
         {
            const typename ::math_expr::core::numeric::details::number_type<T>::type num_type;
         ...
         template <typename T>
         inline ::math_expr::core::_uint64_t to_uint64(const T v)
         {
            const typename ::math_expr::core::numeric::details::number_type<T>::type num_type;
      ...
      template <typename Iterator, typename T>
      inline bool string_to_real(Iterator& itr_external, const Iterator end, T& t, ::math_expr::core::numeric::details::real_type_tag)
      {
         ...
         if (end != itr)
         {
            if ('.' == (*itr))
            {
               ...
               if (curr != itr)
               {
                  ...
                  if (!valid_exponent<T>(frac_exponent, ::math_expr::core::numeric::details::real_type_tag()))
                     return false;
