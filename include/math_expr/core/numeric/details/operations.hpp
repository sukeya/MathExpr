...
namespace math_expr::core::numeric::details
{
            ...
            template <typename T>
            inline ::math_expr::core::_int64_t to_int64_impl(const T v, real_type_tag)
            {
               return static_cast<::math_expr::core::_int64_t>(v);
            }

            template <typename T>
            inline ::math_expr::core::_uint64_t to_uint64_impl(const T v, real_type_tag)
            {
            ...
            template <typename T> inline T  log2_impl(const T v, real_type_tag) { return std::log(v)/T(log2_value); }
            ...
            template <typename T> inline T   r2d_impl(const T v, real_type_tag) { return (v * T(_180_pi)); }
            template <typename T> inline T   d2r_impl(const T v, real_type_tag) { return (v * T(pi_180));  }
            ...
            template <typename T> inline T   const_pi_impl(real_type_tag) { return T(pi);            }
            template <typename T> inline T    const_e_impl(real_type_tag) { return T(e);             }
            ...
            template <typename T> inline T  log2_impl(const T v, int_type_tag) { return std::log(v)/T(log2_value); }
