...
#ifndef MATH_EXPR_RTL_VECOPS_AXPBYZ_HPP
#define MATH_EXPR_RTL_VECOPS_AXPBYZ_HPP

#include "math_expr/rtl/vecops/details/helper.hpp"

namespace math_expr::rtl::vecops
{
template <typename T> class axpbyz final : public math_expr::igeneric_function<T>
{
  public:
    ...
    axpbyz() : math_expr::igeneric_function<T>("TVTVV|TVTVVTT")
    /*
       z <- ax + by
       Overloads:
    ...
    */
    ...
    inline T operator()(const std::size_t& ps_index, parameter_list_t parameters) override
    {
        ...
        if ((1 == ps_index) && !details::load_vector_range<T>::process(parameters, r0, r1, 5, 6, 1))
