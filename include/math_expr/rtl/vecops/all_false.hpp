...
#ifndef MATH_EXPR_RTL_VECOPS_ALL_FALSE_HPP
#define MATH_EXPR_RTL_VECOPS_ALL_FALSE_HPP

#include "math_expr/rtl/vecops/details/helper.hpp"

namespace math_expr::rtl::vecops
{
template <typename T> class all_false final : public math_expr::igeneric_function<T>
{
  public:
    ...
    all_false() : math_expr::igeneric_function<T>("V|VTT|T*")
    /*
       Overloads:
       0. V   - vector
       1. VTT - vector, r0, r1
