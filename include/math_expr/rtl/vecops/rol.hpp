...
#ifndef MATH_EXPR_RTL_VECOPS_ROL_HPP
#define MATH_EXPR_RTL_VECOPS_ROL_HPP

#include "math_expr/rtl/vecops/details/helper.hpp"

namespace math_expr::rtl::vecops
{
template <typename T> class rol final : public math_expr::igeneric_function<T>
{
  public:
    ...
    rol() : math_expr::igeneric_function<T>("VT|VTTT")
    /*
       Overloads:
       0. VT   - vector, N
