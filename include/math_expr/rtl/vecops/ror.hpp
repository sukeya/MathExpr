...
#ifndef MATH_EXPR_RTL_VECOPS_ROR_HPP
#define MATH_EXPR_RTL_VECOPS_ROR_HPP

#include "math_expr/rtl/vecops/details/helper.hpp"

namespace math_expr::rtl::vecops
{
template <typename T> class ror final : public math_expr::igeneric_function<T>
{
  public:
    ...
    ror() : math_expr::igeneric_function<T>("VT|VTTT")
    /*
       Overloads:
       0. VT   - vector, N
