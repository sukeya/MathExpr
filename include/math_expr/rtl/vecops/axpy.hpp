...
#ifndef MATH_EXPR_RTL_VECOPS_AXPY_HPP
#define MATH_EXPR_RTL_VECOPS_AXPY_HPP

#include "math_expr/rtl/vecops/details/helper.hpp"

namespace math_expr::rtl::vecops
{
template <typename T> class axpy final : public math_expr::igeneric_function<T>
{
  public:
    ...
    axpy() : math_expr::igeneric_function<T>("TVV|TVVTT")
    /*
       y <- ax + y
       Overloads:
    ...
    */
    ...
    inline T operator()(const std::size_t& ps_index, parameter_list_t parameters) override
    {
        ...
        if ((1 == ps_index) && !details::load_vector_range<T>::process(parameters, r0, r1, 3, 4, 1))
