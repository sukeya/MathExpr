...
#ifndef MATH_EXPR_RTL_VECOPS_DOT_HPP
#define MATH_EXPR_RTL_VECOPS_DOT_HPP

#include "math_expr/rtl/vecops/details/helper.hpp"

namespace math_expr::rtl::vecops
{
template <typename T> class dot final : public math_expr::igeneric_function<T>
{
  public:
    ...
    dot() : math_expr::igeneric_function<T>("VV|VVTT")
    /*
       Overloads:
