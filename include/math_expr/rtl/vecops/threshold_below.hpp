...
#ifndef MATH_EXPR_RTL_VECOPS_THRESHOLD_BELOW_HPP
#define MATH_EXPR_RTL_VECOPS_THRESHOLD_BELOW_HPP

#include "math_expr/rtl/vecops/details/helper.hpp"

namespace math_expr::rtl::vecops
{
template <typename T> class threshold_below final : public math_expr::igeneric_function<T>
{
  public:
    ...
    threshold_below() : math_expr::igeneric_function<T>("VTT|VTTTT")
    /*
       Overloads:
       0. VTT   - vector, TV, SV
