...
#ifndef MATH_EXPR_RTL_VECOPS_AXPBY_HPP
#define MATH_EXPR_RTL_VECOPS_AXPBY_HPP

#include "math_expr/rtl/vecops/details/helper.hpp"

namespace math_expr::rtl::vecops
{
template <typename T> class axpby final : public math_expr::igeneric_function<T>
{
  public:
    ...
    axpby() : math_expr::igeneric_function<T>("TVTV|TVTVTT")
    /*
       y <- ax + by
       Overloads:
