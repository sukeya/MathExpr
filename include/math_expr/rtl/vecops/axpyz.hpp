...
#ifndef MATH_EXPR_RTL_VECOPS_AXPYZ_HPP
#define MATH_EXPR_RTL_VECOPS_AXPYZ_HPP

#include "math_expr/rtl/vecops/details/helper.hpp"

namespace math_expr::rtl::vecops
{
template <typename T> class axpyz final : public math_expr::igeneric_function<T>
{
  public:
    ...
    axpyz() : math_expr::igeneric_function<T>("TVVV|TVVVTT")
    /*
       z <- ax + y
       Overloads:
