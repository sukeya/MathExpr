...
#ifndef MATH_EXPR_RTL_VECOPS_REVERSE_HPP
#define MATH_EXPR_RTL_VECOPS_REVERSE_HPP

#include "math_expr/rtl/vecops/details/helper.hpp"

namespace math_expr::rtl::vecops
{
template <typename T> class reverse final : public math_expr::igeneric_function<T>
{
  public:
    ...
    reverse() : math_expr::igeneric_function<T>("V|VTT")
    /*
       Overloads:
       0. V   - vector
       1. VTT - vector, r0, r1
