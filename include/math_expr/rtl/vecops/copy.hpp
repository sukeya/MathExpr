...
{
template <typename T> class copy final : public math_expr::igeneric_function<T>
{
  public:
    ...
    copy() : math_expr::igeneric_function<T>("VV|VTTVTT")
    /*
       Overloads:
    ...
    */
    ...
    inline T operator()(const std::size_t& ps_index, parameter_list_t parameters) override
    {
        ...
        if (1 == ps_index)
        {
            if (!details::load_vector_range<T>::process(parameters, xr0, xr1, 1, 2, 0) ||
