...
{
template <typename T>
class conditional_string_node final : public trinary_node<T>,
                                      ...
                                      public range_interface<T>
{
   public:
    ...
    conditional_string_node(expression_ptr condition, expression_ptr consequent,
    ...
    {
        return initialised_ && condition_ && condition_->valid() && consequent_ &&
