...
#ifndef MATH_EXPR_DETAILS_STRING_RANGE_NODE_HPP
#define MATH_EXPR_DETAILS_STRING_RANGE_NODE_HPP
...
{
template <typename T>
class string_range_node final : public expression_node<T>,
                                ...
                                public range_interface<T>
{
  public:
    ...
    explicit string_range_node(std::string& v, const range_t& rp) : value_(&v), rp_(rp) {}
...
template <typename T> std::string string_range_node<T>::null_value = std::string("");
} // namespace math_expr::details::string_nodes
