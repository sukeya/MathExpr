   ...
   private:
               ...
               )
            {
               ...
               else if (!symtab_store_.is_variable(loop_counter_symbol))
               {
                  ...
                  else
                  {
                     ...
                     {
                        math_expr_debug(("parse_for_loop() - INFO - Added new local variable: %s\n", nse.name.c_str()));
      ...
      inline expression_node_ptr parse_define_vector_statement(const std::string& vec_name)
      {
         ...
         if (0 == vec_holder)
         {
            ...
            math_expr_debug(("parse_define_vector_statement() - INFO - Added new local vector: %s[%d]\n",
                          nse.name.c_str(),
      ...
      inline expression_node_ptr parse_define_string_statement(const std::string& str_name, expression_node_ptr initialisation_expression)
      {
         ...
         if (0 == str_node)
         {
            ...
            math_expr_debug(("parse_define_string_statement() - INFO - Added new local string variable: %s\n", nse.name.c_str()));
         }
      ...
      inline expression_node_ptr parse_define_constvar_statement()
      {
         ...
         if (0 == var_node)
         {
            ...
            math_expr_debug(("parse_define_constvar_statement() - INFO - Added new local const-variable: %s\n", nse.name.c_str()));
         }
      ...
      inline expression_node_ptr parse_uninitialised_var_statement(const std::string& var_name)
      {
         ...
         if (0 == var_node)
         {
            ...
            math_expr_debug(("parse_uninitialised_var_statement() - INFO - Added new local variable: %s\n",
                          nse.name.c_str()));
         }
      ...
      inline expression_node_ptr parse_assert_statement()
      {
         ...
         if (0 == assert_check_)
         {
            math_expr_debug(("parse_assert_statement() - assert functionality is disabled. assert condition: %s\n",
         ...
         math_expr_debug(("parse_assert_statement() - assert condition: [%s]\n", context.condition.c_str()      ));
         math_expr_debug(("parse_assert_statement() - assert message:   [%s]\n", context.message  .c_str()      ));
         math_expr_debug(("parse_assert_statement() - assert id:        [%s]\n", context.id       .c_str()      ));
                                                   ...
                                                   expression_node_ptr index)
         {
            ...
            if (details::is_constant_node(index))
            {
               ...
               else
               {
                  ...
                  math_expr_debug(("vector_element() - INFO - Added new local vector element: %s\n", nse.name.c_str()));
                                                      ...
                                                      expression_node_ptr (&branch)[2])
            {
               ...
               if (expr_gen.parser_->settings_.strength_reduction_enabled())
               {
                  ...
                  if ((details::e_div == o0) && (details::e_mul == o1) && (details::e_div == o2))
                  {
                     ...
                     math_expr_debug(("(v0 / v1) * (v2 / v3) --> (vovovov) (v0 * v2) / (v1 * v3)\n"));
                  ...
                  else if ((details::e_div == o0) && (details::e_div == o1) && (details::e_div == o2))
                  {
                     ...
                     math_expr_debug(("(v0 / v1) / (v2 / v3) --> (vovovov) (v0 * v3) / (v1 * v2)\n"));
                  ...
                  else if ((details::e_add == o0) && (details::e_div == o1) && (details::e_div == o2))
                  {
                     ...
                     math_expr_debug(("(v0 + v1) / (v2 / v3) --> (vovovov) (v0 + v1) * (v3 / v2)\n"));
                                                      ...
                                                      expression_node_ptr (&branch)[2])
            {
               ...
               if (expr_gen.parser_->settings_.strength_reduction_enabled())
               {
                  ...
                  if ((details::e_div == o0) && (details::e_mul == o1) && (details::e_div == o2))
                  {
                     ...
                     math_expr_debug(("(v0 / v1) * (v2 / c) --> (vovovoc) (v0 * v2) / (v1 * c)\n"));
                  ...
                  if ((details::e_div == o0) && (details::e_div == o1) && (details::e_div == o2))
                  {
                     ...
                     math_expr_debug(("(v0 / v1) / (v2 / c) --> (vocovov) (v0 * c) / (v1 * v2)\n"));
                                                      ...
                                                      expression_node_ptr (&branch)[2])
            {
               ...
               if (expr_gen.parser_->settings_.strength_reduction_enabled())
               {
                  ...
                  if ((details::e_div == o0) && (details::e_mul == o1) && (details::e_div == o2))
                  {
                     ...
                     math_expr_debug(("(v0 / v1) * (c / v2) --> (vocovov) (v0 * c) / (v1 * v2)\n"));
                  ...
                  if ((details::e_div == o0) && (details::e_div == o1) && (details::e_div == o2))
                  {
                     ...
                     math_expr_debug(("(v0 / v1) / (c / v2) --> (vovovoc) (v0 * v2) / (v1 * c)\n"));
                                                      ...
                                                      expression_node_ptr (&branch)[2])
            {
               ...
               if (expr_gen.parser_->settings_.strength_reduction_enabled())
               {
                  ...
                  if ((details::e_div == o0) && (details::e_mul == o1) && (details::e_div == o2))
                  {
                     ...
                     math_expr_debug(("(v0 / c) * (v1 / v2) --> (vovocov) (v0 * v1) / (c * v2)\n"));
                  ...
                  if ((details::e_div == o0) && (details::e_div == o1) && (details::e_div == o2))
                  {
                     ...
                     math_expr_debug(("(v0 / c) / (v1 / v2) --> (vovocov) (v0 * v2) / (c * v1)\n"));
                                                      ...
                                                      expression_node_ptr (&branch)[2])
            {
               ...
               if (expr_gen.parser_->settings_.strength_reduction_enabled())
               {
                  ...
                  if ((details::e_div == o0) && (details::e_mul == o1) && (details::e_div == o2))
                  {
                     ...
                     math_expr_debug(("(c / v0) * (v1 / v2) --> (covovov) (c * v1) / (v0 * v2)\n"));
                  ...
                  if ((details::e_div == o0) && (details::e_div == o1) && (details::e_div == o2))
                  {
                     ...
                     math_expr_debug(("(c / v0) / (v1 / v2) --> (covovov) (c * v2) / (v0 * v1)\n"));
                                                      ...
                                                      expression_node_ptr (&branch)[2])
            {
               ...
               if (expr_gen.parser_->settings_.strength_reduction_enabled())
               {
                  ...
                  if ((details::e_add == o0) && (details::e_add == o1) && (details::e_add == o2))
                  {
                     ...
                     math_expr_debug(("(c0 + v0) + (c1 + v1) --> (covov) (c0 + c1) + v0 + v1\n"));
                  ...
                  else if ((details::e_div == o0) && (details::e_div == o1) && (details::e_div == o2))
                  {
                     ...
                     math_expr_debug(("(c0 / v0) / (c1 / v1) --> (covov) ((c0 / c1) * v1) / v0\n"));
                                                      ...
                                                      expression_node_ptr (&branch)[2])
            {
               ...
               if (expr_gen.parser_->settings_.strength_reduction_enabled())
               {
                  ...
                  if ((details::e_add == o0) && (details::e_add == o1) && (details::e_add == o2))
                  {
                     ...
                     math_expr_debug(("(v0 + c0) + (v1 + c1) --> (covov) (c0 + c1) + v0 + v1\n"));
                  ...
                  else if ((details::e_sub == o0) && (details::e_sub == o1) && (details::e_sub == o2))
                  {
                     ...
                     math_expr_debug(("(v0 - c0) - (v1 - c1) --> (covov) (c1 - c0) + v0 - v1\n"));
                  ...
                  else if ((details::e_div == o0) && (details::e_mul == o1) && (details::e_div == o2))
                  {
                     ...
                     math_expr_debug(("(v0 / c0) * (v1 / c1) --> (covov) (1 / (c0 * c1)) * v0 * v1\n"));
                  ...
                  else if ((details::e_div == o0) && (details::e_mul == o1) && (details::e_add == o2))
                  {
                     ...
                     math_expr_debug(("(v0 / c0) * (v1 + c1) --> (vocovoc) (v0 * (1 / c0)) * (v1 + c1)\n"));
                                                      ...
                                                      expression_node_ptr (&branch)[2])
            {
               ...
               if (expr_gen.parser_->settings_.strength_reduction_enabled())
               {
                  ...
                  if ((details::e_add == o0) && (details::e_add == o1) && (details::e_add == o2))
                  {
                     ...
                     math_expr_debug(("(c0 + v0) + (v1 + c1) --> (covov) (c0 + c1) + v0 + v1\n"));
                  ...
                  else if ((details::e_div == o0) && (details::e_mul == o1) && (details::e_div == o2))
                  {
                     ...
                     math_expr_debug(("(c0 / v0) * (v1 / c1) --> (covov) (c0 / c1) * (v1 / v0)\n"));
                                                      ...
                                                      expression_node_ptr (&branch)[2])
            {
               ...
               if (expr_gen.parser_->settings_.strength_reduction_enabled())
               {
                  ...
                  if ((details::e_add == o0) && (details::e_add == o1) && (details::e_add == o2))
                  {
                     ...
                     math_expr_debug(("(v0 + c0) + (c1 + v1) --> (covov) (c0 + c1) + v0 + v1\n"));
                  ...
                  else if ((details::e_sub == o0) && (details::e_sub == o1) && (details::e_sub == o2))
                  {
                     ...
                     math_expr_debug(("(v0 - c0) - (c1 - v1) --> (vovoc) v0 + v1 - (c1 + c0)\n"));
                  ...
                  else if ((details::e_div == o0) && (details::e_mul == o1) && (details::e_div == o2))
                  {
                     ...
                     math_expr_debug(("(v0 / c0) * (c1 / v1) --> (covov) (c1 / c0) * (v0 / v1)\n"));
                  ...
                  else if ((details::e_div == o0) && (details::e_div == o1) && (details::e_mul == o2))
                  {
                     ...
                     math_expr_debug(("(v0 / c0) / (c1 * v1) --> (covov) (1 / (c0 * c1)) * (v0 / v1)\n"));
                  ...
                  else if ((details::e_div == o0) && (details::e_div == o1) && (details::e_div == o2))
                  {
                     ...
                     math_expr_debug(("(v0 / c0) / (c1 / v1) --> (vovoc) (v0 * v1) * (1 / (c0 * c1))\n"));
