...
if(NOT configure_result EQUAL 0)
  message(FATAL_ERROR
    "Failed to configure the default-epsilon verification build.\n"
    "stdout:\n${configure_stdout}\n"
    "stderr:\n${configure_stderr}")
endif()

execute_process(
  COMMAND "${CMAKE_COMMAND}" --build "${BINARY_DIR}" --target math_expr_default_epsilon_verify
...
if(NOT build_result EQUAL 0)
  message(FATAL_ERROR
    "Failed to build the default-epsilon verification target.\n"
    "stdout:\n${build_stdout}\n"
    "stderr:\n${build_stderr}")
endif()
...
if(NOT test_result EQUAL 0)
  message(FATAL_ERROR
    "The default-epsilon verification test failed.\n"
    "stdout:\n${test_stdout}\n"
    "stderr:\n${test_stderr}")
endif()
