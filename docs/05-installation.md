...
MathExpr is a header-only C++ library distributed as a CMake package. There are three ways to use it in a project.
...
MathExpr requires a C++20-capable compiler.
